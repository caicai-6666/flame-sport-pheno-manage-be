"""定义规划模型按需读取单张表实际数据的 Pydantic 工具模型。"""
...
def parse_table_data_inspection_tool_arguments(
    ...
    return TableDataInspectionToolArguments.model_validate_json(arguments_json)
...
def parse_next_table_data_inspection_page_tool_arguments(
    ...
    return NextTableDataInspectionPageArguments.model_validate_json(arguments_json)
...
def parse_clear_table_data_inspection_context_tool_arguments(
    ...
    return ClearTableDataInspectionContextArguments.model_validate_json(arguments_json)
